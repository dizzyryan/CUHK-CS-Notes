...
\input{../header.tex}
\author{Ryan Chan}
\title{CSCI4130 Introduction to Cyber Security}
...
\begin{abstract}
	This is a note for \textbf{CSCI4130 Introduction to Cyber Security}. 
	
	Contents are adapted from the lecture notes of CSCI4130, prepared by \href{https://www.cse.cuhk.edu.hk/~wei/}{Wei Meng}, as well as some online resources.
