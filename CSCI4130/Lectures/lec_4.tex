...
\subsection{Indistinguishability under Known Plaintext Attack (IND-KPA)}
...
\subsection{Indistinguishability under Chosen Plaintext Attack (IND-CPA)}
...
\section{Integrity and Authentication}
