...
A frame can load images, CSS, and fonts from another origin. It cannot inspect the content of the resources, but it is similar to loading an iframe from another origin to ensure safety. 
