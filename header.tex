...
\newenvironment{codeBlock}%
   {\par\noindent\adjustbox{margin=1ex,bgcolor=Gray!20,margin=0.5ex \medskipamount}\bgroup\varwidth\linewidth\verbatim}%
   {\endverbatim\endvarwidth\egroup}

\newenvironment{codeLargeBlock}%
   {\par\noindent\adjustbox{margin=1ex,bgcolor=Gray!20,margin=0.5ex \medskipamount}\bgroup\minipage\linewidth\verbatim}%
