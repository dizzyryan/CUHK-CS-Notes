...
We have talked about the case that \(\sigma^2\) is known. Now, suppose that \(\sigma^2\) is unknown, but \(n\) is large (\(n \geq 30\)), then a confidence interval for the mean can also be found by:
\[
