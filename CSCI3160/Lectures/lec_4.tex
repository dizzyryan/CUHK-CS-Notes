...
\textbf{Key idea:} At each level, the recursive results are reused for multiple points; only the multiplication by \(\omega_n^k\) differs. This divide-and-conquer gives total complexity \(\mathcal{O} (n \log n)\).
\end{explanation}
